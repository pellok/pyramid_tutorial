...
pages = {
    '100': dict(uid='100', title='Page 100', body='<em>100 this is a pages body.</em>'),
...
class WikiViews(object):
    ...
    @view_config(route_name='wikipage_del')
    def wikipage_del(self):
        del_uid = self.request.matchdict['uid']
        pages.pop(str(del_uid))

        return HTTPFound(self.request.route_path('wiki_view'))
